  ...
  return {
    validate(data = {}, joiSchema = {}, options = {}, callback) {
      invariant(
        ...
        "joi-validation-strategy is asynchronous, a callback is expected: validate(data, schema, options, callback)"
      );
      ...
      const { error } = joiSchema.validate(data, validationOptions);
